  ...
  function(ko, Context, moduleUtils, KnockoutTemplateUtils, CoreRouter, ModuleRouterAdapter, KnockoutRouterAdapter, UrlParamAdapter, ResponsiveUtils, ResponsiveKnockoutUtils, ArrayDataProvider) {
     ...
     function ControllerViewModel() {
      ...
      let navData = [
        ...
        { path: 'customers', detail: { label: 'Blogs', iconClass: 'oj-ux-ico-contact-group' } },
      ...
      this.appName = ko.observable("Sai Teja's Redwood Application");
      // User Info used in Global Navigation area
      this.userLogin = ko.observable("saitejaappala@gmail.com");
